...
import { OpeningHourComponent } from 'app/entities/opening-hour/opening-hour.component';
...
describe('Component Tests', () => {
    describe('OpeningHour Management Component', () => {
        let comp: OpeningHourComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OpeningHourComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.openingHours[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
