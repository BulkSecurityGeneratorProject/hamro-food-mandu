...
import { ResturantComponent } from 'app/entities/resturant/resturant.component';
...
describe('Component Tests', () => {
    describe('Resturant Management Component', () => {
        let comp: ResturantComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ResturantComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.resturants[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
